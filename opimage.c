...
//First is the source file name (can be jpg, png, bmp, tga).  
...
int main(int argc,char** argv){
    ...
    stbi_write_png("ompoutput.png",destImage.width,destImage.height,destImage.bpp,destImage.data,destImage.bpp*destImage.width);
